...
export default function Mens() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const res = await axios.get("http://127.0.0.1:5000/api/product/mens");
  ...
  // It checks if the search term is present in the product name, brand, or category
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-center mb-3">👕 Men's Products</h2>
